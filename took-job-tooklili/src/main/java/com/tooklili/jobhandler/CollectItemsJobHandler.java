 ...
 */
@JobHander(value="collectItemsJobHandler")
@Service
public class CollectItemsJobHandler extends IJobHandler{
	private static final Logger LOGGER = LoggerFactory.getLogger(CollectItemsJobHandler.class);
